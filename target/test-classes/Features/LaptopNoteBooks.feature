...
Feature: Laptop & NoteBooks
  ...
  Scenario: Add and Remove a Mac book from Cart
    ...
    Then User should see a message2 'Success: You have added MacBook to your shopping cart!'
  ...
  Scenario: Product Comparison
    ...
    Then User should see a comparision message 'Success: You have added MacBook Air to your product comparison!'
